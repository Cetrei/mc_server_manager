...
**Test E2E**: `tests/cf-tunnel/remote-e2e.test.ts` — pendiente de correr contra el túnel real al menos una vez (requiere `MC_TUNNEL_TEST_DOMAIN`, ver sección de comandos al final de este documento hasta que se mueva a un README de progreso).
